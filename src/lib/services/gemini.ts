...
${request.extractedTypography ? `
📝 EXTRACTED TYPOGRAPHY FROM LOGO:
${request.extractedTypography}

IMPORTANT: Use the typography recommendations above as the foundation. These were generated by analyzing the logo's typography style using AI vision. Build upon these recommendations and create comprehensive typography guidelines.
` : `
Generate brief typography content (1-2 lines per section) for ${previousSteps.brand_domain || 'General Business'} industry.
...
**Primary Font**: [Exact Font Name] - [1-2 line description]
**Supporting Font**: [Exact Font Name] - [1-2 line description]
...
- Use exact font names: "Inter", "Roboto", "Montserrat", "Poppins", "Georgia", "Helvetica", "Arial", "Times New Roman", "Open Sans", "Lato"
...
IMPORTANT: 
- Use **bold** formatting for ALL headings
- Generate typography based on user's brand mood, domain, and preferences
- Keep descriptions brief - maximum 1-2 lines each
