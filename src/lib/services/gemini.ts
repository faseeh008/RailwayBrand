...
You are a typography expert. Generate comprehensive typography guidelines for this brand based on the user's requirements.

BRAND CONTEXT:
- Brand Name: ${previousSteps.brand_name || 'Your Brand'}
- Industry/Domain: ${previousSteps.brand_domain || 'General Business'}
- Brand Description: ${previousSteps.short_description || 'Professional brand'}
...
TYPOGRAPHY GENERATION REQUIREMENTS:
- Generate BOTH primary and supporting fonts based on the brand's domain, mood, description, and target audience
- Consider the industry standards and typography best practices for ${previousSteps.brand_domain || 'General Business'}
- Choose fonts that match the brand mood: ${(previousSteps as any).selectedMood || (previousSteps as any).mood || 'Professional'}
- Select fonts appropriate for the target audience: ${(previousSteps as any).selectedAudience || (previousSteps as any).audience || 'General audience'}
- Ensure fonts are professional, readable, and align with the brand's personality
- Primary font should work well for headlines and key messaging
- Supporting font should be highly readable for body text and long-form content
- Fonts should complement each other and create a cohesive typographic system
...
CRITICAL REQUIREMENTS:
- Keep all descriptions brief - maximum 1-2 lines each
- Generate typography SPECIFICALLY appropriate for ${previousSteps.brand_domain || 'General Business'} industry
- Make content concise but actionable
- Generate fonts that align with the brand mood: ${(previousSteps as any).selectedMood || (previousSteps as any).mood || 'Professional'}
- Consider the target audience: ${(previousSteps as any).selectedAudience || (previousSteps as any).audience || 'General audience'}

FORMAT AS (EXACT STRUCTURE):
**Primary Font**: [Exact Font Name] - [1-2 line description explaining why this font fits the brand]
...
**Web Usage**: [1-2 line web implementation]
**Print Usage**: [1-2 line print guidelines]

CRITICAL FORMAT REQUIREMENTS:
- Font name MUST come IMMEDIATELY after "**Primary Font**:" or "**Supporting Font**:"
- Use exact font names from professional font libraries: "Inter", "Roboto", "Montserrat", "Poppins", "Georgia", "Helvetica", "Arial", "Times New Roman", "Open Sans", "Lato", "Playfair Display", "Source Sans Pro", "Raleway", "Nunito", "Merriweather", "Libre Baskerville", "Crimson Text", "Work Sans", "DM Sans", "Space Grotesk", "IBM Plex Sans", "Fira Sans", "Noto Sans", "Rubik", "Ubuntu", "Oswald", "Bebas Neue", "Futura", "Gotham", "Proxima Nova"
- Correct: **Primary Font**: Montserrat - Modern and clean sans-serif for headings
- Correct: **Supporting Font**: Open Sans - Readable sans-serif for body text
- WRONG: **Primary Font**: A modern font like Montserrat (this won't work!)

TYPOGRAPHY SELECTION GUIDELINES:
- For professional/corporate brands: Consider clean sans-serifs like Inter, Roboto, or Helvetica
- For creative/artistic brands: Consider distinctive fonts like Montserrat, Poppins, or Playfair Display
- For traditional/classic brands: Consider serif fonts like Georgia, Times New Roman, or Merriweather
- For modern/tech brands: Consider geometric sans-serifs like Space Grotesk, DM Sans, or Work Sans
- For luxury/premium brands: Consider elegant fonts like Playfair Display, Crimson Text, or Libre Baskerville
- Always ensure the primary and supporting fonts work well together
- Consider readability across different devices and platforms
- Ensure fonts are widely available (Google Fonts, Adobe Fonts, or system fonts)

IMPORTANT: 
- Use **bold** formatting for ALL headings
- Generate typography based on user's brand mood (${(previousSteps as any).selectedMood || (previousSteps as any).mood || 'Professional'}), domain (${previousSteps.brand_domain || 'General Business'}), description, and target audience
- Keep descriptions brief - maximum 1-2 lines each
- Always specify exact font names as the FIRST word(s) after the colon
- Make typography SPECIFICALLY appropriate for ${previousSteps.brand_domain || 'General Business'} industry
...
Return ONLY the formatted text above with correct font names.`;

		case 'iconography':
			return `${baseInfo}

Generate a comprehensive monochrome icon set for ${previousSteps.brand_domain || 'General Business'} industry.
...
- If they want different symbols or styles, implement those changes EXACTLY
- If they want more/fewer icons, adjust the count accordingly
- DO NOT ignore any icon requests - they are REQUIREMENTS
- If they want specific Unicode symbols, use those EXACT symbols

` : ''}

CRITICAL REQUIREMENTS:
- Generate 8-10 icons with diverse monochrome Unicode symbols
- Include UI/Navigation icons (button, menu, search, settings, etc.)
- Include Domain-specific icons (relevant to ${previousSteps.brand_domain || 'General Business'})
- Include Action icons (add, edit, delete, save, etc.)
- Include Communication icons (phone, email, chat, etc.)
- Use diverse monochrome Unicode symbols: ⚫, ⚪, ⚡, ⚙, ⚠, ⚰, ⚱, ★, ☆, ♦, ♠, ♣, ♥, ♪, ♫, ♬, ♭, ♮, ♯, ▲, ▼, ◄, ►, ◆, ◇, ○, ●, ◎, ◐, ◑, ◒, ◓, ◔, ◕, ◖, ◗, ◘, ◙, ◚, ◛, ◜, ◝, ◞, ◟, ◠, ◡, ◢, ◣, ◤, ◥, ◦, ◧, ◨, ◩, ◪, ◫, ◬, ◭, ◮, ◯, ◰, ◱, ◲, ◳, ◴, ◵, ◶, ◷, ◸, ◹, ◺, ◻, ◼, ◽, ◾, ◿, ☀, ☁, ☂, ☃, ☄, ★, ☆, ☇, ☈, ☉, ☊, ☋, ☌, ☍, ☎, ☏, ☐, ☑, ☒, ☓, ☔, ☕, ☖, ☗, ☘, ☙, ☚, ☛, ☜, ☝, ☞, ☟, ☠, ☡, ☢, ☣, ☤, ☥, ☦, ☧, ☨, ☩, ☪, ☫, ☬, ☭, ☮, ☯, ☰, ☱, ☲, ☳, ☴, ☵, ☶, ☷, ☸, ☹, ☺, ☻, ☼, ☽, ☾, ☿, ♀, ♁, ♂, ♃, ♄, ♅, ♆, ♇, ♈, ♉, ♊, ♋, ♌, ♍, ♎, ♏, ♐, ♑, ♒, ♓, ♔, ♕, ♖, ♗, ♘, ♙, ♚, ♛, ♜, ♝, ♞, ♟, ♠, ♡, ♢, ♣, ♤, ♥, ♦, ♧, ♨, ♩, ♪, ♫, ♬, ♭, ♮, ♯, ♰, ♱, ♲, ♳, ♴, ♵, ♶, ♷, ♸, ♹, ♺, ♻, ♼, ♽, ♾, ♿, ⚀, ⚁, ⚂, ⚃, ⚄, ⚅, ⚆, ⚇, ⚈, ⚉, ⚊, ⚋, ⚌, ⚍, ⚎, ⚏, ⚐, ⚑, ⚒, ⚓, ⚔, ⚕, ⚖, ⚗, ⚘, ⚙, ⚚, ⚛, ⚜, ⚝, ⚞, ⚟, ⚠, ⚡, ⚢, ⚣, ⚤, ⚥, ⚦, ⚧, ⚨, ⚩, ⚪, ⚫, ⚬, ⚭, ⚮, ⚯, ⚰, ⚱, ⚲, ⚳, ⚴, ⚵, ⚶, ⚷, ⚸, ⚹, ⚺, ⚻, ⚼, ⚽, ⚾, ⚿, ⛀, ⛁, ⛂, ⛃, ⛄, ⛅, ⛆, ⛇, ⛈, ⛉, ⛊, ⛋, ⛌, ⛍, ⛎, ⛏, ⛐, ⛑, ⛒, ⛓, ⛔, ⛕, ⛖, ⛗, ⛘, ⛙, ⛚, ⛛, ⛜, ⛝, ⛞, ⛟, ⛠, ⛡, ⛢, ⛣, ⛤, ⛥, ⛦, ⛧, ⛨, ⛩, ⛪, ⛫, ⛬, ⛭, ⛮, ⛯, ⛰, ⛱, ⛲, ⛳, ⛴, ⛵, ⛶, ⛷, ⛸, ⛹, ⛺, ⛻, ⛼, ⛽, ⛾, ⛿
- Generate symbols dynamically based on domain context and brand mood
- Choose appropriate symbols that match the brand's personality and industry

FORMAT AS:
• [Monochrome Symbol] [Icon Name]
• [Monochrome Symbol] [Icon Name]
• [Monochrome Symbol] [Icon Name]
• [Monochrome Symbol] [Icon Name]
• [Monochrome Symbol] [Icon Name]
...
- Fashion: ⚫ Button, ♥ Heart, ⚡ Flash Sale, ⚙ Settings, ⚠ Alert, ★ Star, ♦ Diamond, ♪ Music
- Healthcare: ⚫ Button, ⚕ Medical, ⚡ Emergency, ⚙ Settings, ⚠ Warning, ★ Review, ♦ Prescription, ♪ Therapy
- Food: ⚫ Button, ⚡ Fast Service, ⚙ Settings, ⚠ Allergen, ★ Rating, ♦ Chef, ♪ Ambiance, ♥ Love

IMPORTANT: 
- Use DIFFERENT symbols for each icon (no duplicates)
- Choose symbols that are relevant to ${previousSteps.brand_domain || 'General Business'} industry
- Match symbols to the brand mood: ${(previousSteps as any).selectedMood || 'Professional'}
- Generate icons that reflect the brand's personality and target audience

Return ONLY the bullet list above with diverse monochrome symbols and names for ${previousSteps.brand_domain || 'General Business'} industry.`;
