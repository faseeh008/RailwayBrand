  ...
  function createSlideData(): SlideData {
    return {
      ...
      elements: [
        ...
        // Left border (colored accent bar)
        {
          id: 'border-left',
          type: 'shape' as const,
...
<div class="brand-intro-slide" style="background: {backgroundGradient};">
  <div class="radial-overlay" style="background: {radialOverlayStyle};"></div>
  
  <div class="slide">
    <div class="header" style="border-bottom: {headerBorderStyle};">
      <div class="title" style="color: {titleColorStyle};">Brand Introduction</div>
    </div>
    
    <div class="content">
      <div class="positioning-statement" style="border-left: {borderLeftStyle};">
        {#if isEditable}
          <textarea
