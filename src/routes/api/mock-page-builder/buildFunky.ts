...
export async function buildFunky(sessionData: BrandSessionData): Promise<string> {
	...
	console.log('[buildFunky] Fetching images for industry:', sessionData.brand_industry);
	await sleep(3000);
	...
	console.log('[buildFunky] Brand config prepared with generated content and gradients:', brandConfig);
	await sleep(3000);
