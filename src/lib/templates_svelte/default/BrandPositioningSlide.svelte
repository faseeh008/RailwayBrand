<script lang="ts">
  ...
  $: missionCardTitleColorStyle = color1Hex;
  $: visionCardBgStyle = color2Lighter;
  $: visionCardBorderStyle = color2Hex;
  $: visionCardTitleColorStyle = color2Hex;
  $: valuesCardBgStyle = color3Lighter;
  $: valuesCardBorderStyle = color3Hex;
  $: valuesCardTitleColorStyle = color3Hex;
...
<div class="brand-positioning-slide" style="background: linear-gradient(135deg, {color2Lighter} 0%, {color3Lighter} 25%, #FFFFFF 50%, {color1Lighter} 75%, #FFFFFF 100%);">
  ...
  <div class="slide">
    <div class="title" style="color: {titleColorStyle};">BRAND POSITIONING</div>
    <div class="divider" style="background: {dividerBgStyle};"></div>
    
    <div class="cards-row">
      <div class="card mission" style="background: {missionCardBgStyle}; border-color: {missionCardBorderStyle};">
        <div class="card-title" style="color: {missionCardTitleColorStyle};">MISSION</div>
      ...
      <div class="card vision" style="background: {visionCardBgStyle}; border-color: {visionCardBorderStyle};">
        <div class="card-title" style="color: {visionCardTitleColorStyle};">VISION</div>
        <div class="card-content">
          {#if isEditable}
    ...
    <div class="card values" style="background: {valuesCardBgStyle}; border-color: {valuesCardBorderStyle};">
      <div class="card-title" style="color: {valuesCardTitleColorStyle};">CORE VALUES</div>
      <div class="card-content">
        {#if isEditable}
    ...
    <div class="card values" style="margin-top: 15px; background: {valuesCardBgStyle}; border-color: {valuesCardBorderStyle};">
      <div class="card-title" style="color: {valuesCardTitleColorStyle};">TARGET AUDIENCE</div>
      <div class="card-content">
        {#if isEditable}
